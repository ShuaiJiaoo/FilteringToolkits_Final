...
class Ui_centralWidget(object):
    def setupUi(self, centralWidget):
        ...
        self.doubleSpinBoxTime.setMinimumSize(QtCore.QSize(0, 0))
        self.doubleSpinBoxTime.setDecimals(1)
        self.doubleSpinBoxTime.setMinimum(0.0)
        self.doubleSpinBoxTime.setMaximum(1.0)
        self.doubleSpinBoxTime.setSingleStep(0.1)
        self.doubleSpinBoxTime.setProperty("value", 0.0)
        ...
        self.doubleSpinBoxStoracy.setMinimum(0.0)
        self.doubleSpinBoxStoracy.setMaximum(1.0)
        self.doubleSpinBoxStoracy.setSingleStep(0.1)
        self.doubleSpinBoxStoracy.setProperty("value", 0.0)
        ...
        self.doubleSpinBoxAccuracy.setMinimum(0.0)
        self.doubleSpinBoxAccuracy.setMaximum(1.0)
        self.doubleSpinBoxAccuracy.setSingleStep(0.1)
        self.doubleSpinBoxAccuracy.setProperty("value", 0.0)
    ...
    def retranslateUi(self, centralWidget):
        ...
        self.label.setText(_translate("centralWidget", "Time"))
        self.label_2.setText(_translate("centralWidget", "Performance"))
        self.label_5.setText(_translate("centralWidget", "Variation"))
